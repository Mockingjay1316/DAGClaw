...
export function CenterPanel() {
  ...
  return (
    <div ref={containerRef} className="flex-1 flex flex-col min-w-[400px] overflow-hidden">
      ...
      <div className="flex-shrink-0 p-3" style={{ height: `${topPanelPercent}%` }}>
        <div className="h-full rounded-xl border border-gray-700 bg-gray-800/50 p-4 flex flex-col">
          <TaskCreationBar className="h-full" />
        </div>
      </div>
